  ...
  return (
    <>
      <div
        ...
        className={cn(
          'group relative flex flex-col gap-3 rounded-xl bg-white p-4 shadow-sm border border-slate-200/60 border-l-4 cursor-pointer transition-all duration-300 ease-in-out hover:shadow-md hover:-translate-y-1 active:cursor-grabbing animate-fade-in-up touch-manipulation',
          isDragging &&
