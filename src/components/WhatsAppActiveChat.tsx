...
export function WhatsAppActiveChat() {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#EFEAE2] animate-fade-in absolute inset-0 z-30 sm:relative">
      <div className="h-[72px] sm:h-16 bg-[#F0F2F5] px-2 sm:px-4 flex items-center justify-between border-b border-slate-200 shrink-0 shadow-sm z-10">
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            size="icon"
            className="h-12 w-12 sm:h-10 sm:w-10 sm:-ml-2 text-slate-600 hover:bg-slate-200/60 rounded-full shrink-0 sm:hidden"
