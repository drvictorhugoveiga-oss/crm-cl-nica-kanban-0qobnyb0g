    ...
    <div className="flex-1 h-full overflow-x-auto kanban-scroll p-4 sm:p-6 pb-8 flex gap-4 sm:gap-6 items-start snap-x snap-mandatory scroll-smooth">
      {isLoading && columns.length === 0 ? (
        Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="min-w-[300px] w-[85vw] sm:w-[320px] max-w-[350px] shrink-0 bg-slate-100/60 rounded-2xl h-full p-3 flex flex-col gap-3"
          >
        ...
        <>
          ...
          <div className="min-w-[300px] w-[85vw] sm:w-[320px] shrink-0 snap-center pt-2">
            <Button
              variant="outline"
