  ...
  return (
    <div className="p-4 sm:p-6 bg-background h-full overflow-y-auto w-full animate-fade-in">
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">Dashboard de Análise</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {isLoading && leads.length === 0 ? (
            ...
            <>
              <Card className="shadow-sm border-border transition-all hover:shadow-md animate-fade-in">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <CardTitle className="text-sm font-medium text-muted-foreground">
                    Total de Leads
                  </CardTitle>
                  <div className="p-2 bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 rounded-full shrink-0">
              ...
              <Card className="shadow-sm border-border transition-all hover:shadow-md animate-fade-in">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  ...
                  <div className="p-2 bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400 rounded-full shrink-0">
              ...
              <Card className="shadow-sm border-border transition-all hover:shadow-md animate-fade-in">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground/80 mt-1">Receita potencial total</p>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-sm border-border transition-all hover:shadow-md animate-fade-in">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  ...
                  <div className="p-2 bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400 rounded-full shrink-0">
                    <TrendingUp className="h-4 w-4" />
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold text-foreground">{stats.roi}%</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <Card className="shadow-sm border-border min-h-[300px] flex flex-col">
            <CardHeader>
              <CardTitle className="text-base text-foreground">Conversão por Origem</CardTitle>
            </CardHeader>
          ...
          <Card className="shadow-sm border-border min-h-[300px] flex flex-col">
            <CardHeader>
              <CardTitle className="text-base text-foreground">Evolução de Leads</CardTitle>
            </CardHeader>
