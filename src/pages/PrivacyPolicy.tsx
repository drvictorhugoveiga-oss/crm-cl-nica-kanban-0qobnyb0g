export default function PrivacyPolicy() {
  return (
    <div className="h-full w-full overflow-y-auto bg-[#F8FAFC]">
      <div className="p-8 max-w-4xl mx-auto prose prose-slate animate-fade-in bg-white shadow-sm border border-slate-200 rounded-2xl my-8">
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-6 mb-3">1. Introdução</h2>
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-6 mb-3">2. Coleta de Dados</h2>
        <p className="text-slate-600 mb-4 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-6 mb-3">3. Uso dos Dados</h2>
