...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!geminiApiKey) {
      ...
      const staleLeads =
        leads?.filter((l: any) => new Date(l.updated_at) < fortyEightHoursAgo) || []
      ...
      suggestions.push({
        ...
        suggestion_text:
          "Notamos que a origem 'Instagram' tem gerado leads com maior valor médio recentemente. Considere aumentar o investimento ou replicar a abordagem.",
